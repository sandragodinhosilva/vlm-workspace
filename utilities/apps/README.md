...
# On your Mac: clusterweb (SOCKS profile) opens http://login-1:7862/ directly.
# Tunnel fallback only for localhost-bound apps (terminate on the app's node): ssh -N -L 17862:127.0.0.1:7862 login-1
```
